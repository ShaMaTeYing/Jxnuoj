		...
		<div class="list">
			<table class="table table-bordered mystyle">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<a href="__APP__/Exam/showProblem/id/<?php echo ($vo["contest_problem_id"]); ?>">
							<?php echo ($vo["contest_problem_id"]); ?>
							</a>
						</td>
						
						<td><?php echo ($vo["exe_time"]); ?> MS</td>
						<td>
							<?php if(($vo["contest_user_id"]) == $myId): ?><a href="__APP__/Exam/showCode/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["code_len"]); ?>B</a>
							<?php else: ?>
