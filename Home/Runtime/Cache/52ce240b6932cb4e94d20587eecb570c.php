...
<html>
					...
					<?php else: ?>
					 <li class="dropdown">
						 ...
						 <ul class="dropdown-menu">
							...
							<li><a href="__APP__/Index/showUserMessage/username/<?php echo ($data["username"]); ?>"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>
							&nbsp;信息</a></li>
	...
	<div class="content">
		<div class="search">
			<form action="__APP__/Admin/sort_all_user" method="post">
				 <div class="col-lg-6">
		...
		<div class="modify">
			<table  class="table table-striped table-bordered mystyle">
				...
				<?php if(is_array($problemData)): $i = 0; $__LIST__ = $problemData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td> <a href="__APP__/Index/showUserMessage/username/<?php echo ($vo["username"]); ?>"><?php echo ($vo["username"]); ?> </a></td>
