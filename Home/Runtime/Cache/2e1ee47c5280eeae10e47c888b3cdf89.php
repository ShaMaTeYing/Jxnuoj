					...
					<?php else: ?>
					 <li class="dropdown">
						 ...
						 <ul class="dropdown-menu">
							...
							&nbsp;信息</a></li>
							<?php if(($data["root"]) > "0"): ?><li><a href="__APP__/Admin/showProblemLibrary"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;&nbsp;管理</a></li><?php endif; ?>
	...
	<div class="content">
		...
		<div class="modify">
			<table  class="table table-striped table-bordered mystyle">
				...
				<?php if(is_array($userMessage)): $i = 0; $__LIST__ = $userMessage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td> 
						...
						<td>
							...
							<?php if(($vo["status"]) == "2"): ?>邮箱未验证<?php endif; ?>
						</td>
						<td>
							<?php if(($vo["root"]) == "0"): ?>普通用户<?php endif; ?>
							<?php if(($vo["root"]) == "1"): ?>管理员<?php endif; ?>
							<?php if(($vo["root"]) == "2"): ?>超级管理员<?php endif; ?>
						</td>
						<td><?php echo ($vo["school"]); ?></td>
						<td><?php echo ($vo["major"]); ?></td>
						<td>
							<?php if(($vo["status"]) == "0"): ?><a href="__APP__/Admin/operation/type/1/id/<?php echo ($vo["id"]); ?>/status/1">
									启用
								</a>
								<?php else: ?>
								<a href="__APP__/Admin/operation/type/1/id/<?php echo ($vo["id"]); ?>/status/0">
									禁用
								</a><?php endif; ?>
							
							<?php if(($data["root"]) == "2"): ?>|
								<?php if(($vo["root"]) == "1"): ?><a href="__APP__/Admin/operation/type/2/id/<?php echo ($vo["id"]); ?>/status/0">
										设为普通用户
									</a>
									<?php else: ?>
									<a href="__APP__/Admin/operation/type/2/id/<?php echo ($vo["id"]); ?>/status/1">
										设为管理员
									</a><?php endif; endif; ?>
						</td>
