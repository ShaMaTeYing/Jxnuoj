...
<html>
	...
	<div class="content">
		<div class="search">
			<form action="__APP__/Admin/showLoginMessage" method="post">
				 <div class="col-lg-6">
		...
		<div class="modify">
			<table  class="table table-striped table-bordered mystyle">
				...
				<?php if(is_array($loginMessage)): $i = 0; $__LIST__ = $loginMessage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td> <a href="__APP__/Index/showUserMessage/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["username"]); ?> </a></td>
