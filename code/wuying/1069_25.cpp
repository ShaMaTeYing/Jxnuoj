...
int v[]={20,10,5,1};
char *Months[20]={"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
int main()
{
    ...
    while(~scanf("%d/%d/%d, %d:%d:%d",&Year,&Month,&Day,&h,&m,&s))
    {

        printf("%s %d, %d  %d:%02d:%02d %s\n",Months[Month-1],Day,Year,(h%12)==0?12:h%12,m,s,h>=12?"PM":"AM");
    }
    return 0;
}
